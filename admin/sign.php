<?php
	...
	if(isset($_POST['btnLogin'])) {
		...
		$msg = '';
			...
			$myQuery = mysql_query("SELECT * FROM employees WHERE username='$username' AND number='$password'")
						...
						if($row['status']!=1){
							...
							$msg = "Inactive Account!";
								...
								if($row2['role'] == 'Administrator')
								{
									...
									$_SESSION['login'] = $login;
									$msg = "Unauthorized Access! Not an Administrator!";
								}
						}
				}
				else {
